...
float speedMeasurement(list <Annotation>::iterator itList, list <Annotation> annotations, char axis = 'x'); //count speed of object beetwen current and previous frame
...
void drawSpeed(cv::Mat, float, float, list <Annotation>::iterator, list <Annotation>, char);
