...
int speedMeasurement(list <Annotation>::iterator itList, list <Annotation> annotations, list <Annotation>::iterator prev, char axis = 'x'); //count speed of object beetwen current and previous frame
